...
def arguments():
    ...
    parser.add_argument("--prediction", type=str, default="test-llava-7b-4bit-mini.json")
    parser.add_argument("--dataset_name", type=str, default="KaiChen1998/coda-lm-llava-format")
    parser.add_argument("--split", type=str, default="Test")
    # parser.add_argument("--save", type=str, default="gemini_eval.json")
    parser.add_argument("--api_key", type=str, default="AIzaSyCjqvgpzVnpgs-pleMI4YsIp1pTVqWIals")
...
if __name__ == "__main__":
    ...
    # Load dataset  
    reference = load_dataset(args.dataset_name, name="English", split=args.split, streaming=True)
    ...
    for sample_type, scores in result.items():
        ...
        total.append(score)
    print("LLM judges", np.mean(total))
